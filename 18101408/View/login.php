...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="wrapper">
      <img class="or" src="image/or.png" alt="">
      <div class="block1">
        <img src="image/b03d2323-9462-4741-89ef-c2bb047fff18-en.jfif" alt="">
        <h2>Get Started</h2>
        <p>sign up with</p>
       ...
       <div class="block2">
        ...
        <div class="form">
          <form class="register-form" action="../Model/show_info.inc.php" method="POST">
          ...
          <form class="login-form" action="../Model/show_info.inc.php" method="POST">
    ...
    <script src="../Controller/loginscript.js" charset="utf-8"></script>
  </body>
</html>
